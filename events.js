...
router.post('/', async (req, res) => {
  ...
  const defaultValues = {
    ...
    requires_equipment: requires_equipment || false,
    chairs_qty: chairs_qty || 0,
    tables_qty: tables_qty || 0,
    projector: projector || false,
    other_equipment: other_equipment || '',
    setup_start_time: setup_start_time || null,
    setup_end_time: setup_end_time || null,
    setup_hours: setup_hours || 0,
    event_start_time: event_start_time || null,
    event_end_time: event_end_time || null,
    event_hours: event_hours || 0,
    cleanup_start_time: cleanup_start_time || null,
    cleanup_end_time: cleanup_end_time || null,
    cleanup_hours: cleanup_hours || 0,
